...
- **Config vs data split.** User-editable config (flows, `actions.yml`,
  ...
  appearance: {theme: "", terminal_font_size: "", terminal_show_windows: true}   # terminal_font_size: small/medium/large/xl/xxl, "" = medium; terminal_show_windows lists every session's windows in the terminal sidebar
