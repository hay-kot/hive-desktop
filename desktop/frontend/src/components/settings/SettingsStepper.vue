...
// A nudge ladder in SettingsSegmented's strip: minus, the live value, plus.
// For a setting whose range is open rather than a handful of named options,
// where a segmented control would need a button per rung.
...
// of stopping a step short of it — the same arithmetic the keyboard ladder does.
