# 0064 — A created workspace starts with an AGENTS.md scaffold
...
ADR 0062 split a workspace into authored files (`agent-workspace.yaml`,
...
model ADR 0062 explicitly declines. The scaffold freezing at creation is the
...
Related decisions: ADR 0062 (the authored/generated split and why prose lives
in `AGENTS.md`), ADR 0061 (the authority model the scaffolded workspace runs
under).
