# 0026 — One-line install script behind an obscure path
...
channel manifests ([0003](0003-r2-manifest-distribution.md),
[0004](0004-release-channels.md)); first install should resolve the same way so
...
1. **A `curl | bash` one-liner, served as a static asset by the existing
   landing-page worker ([0005](0005-web-workers-static-assets.md))** and shipped
