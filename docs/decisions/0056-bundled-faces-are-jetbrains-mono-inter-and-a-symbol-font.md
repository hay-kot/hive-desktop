# 0056 — The bundled faces are JetBrains Mono, Inter, and a symbol font
...
ADR 0050 bundled CaskaydiaMono Nerd Font as five static weights plus italics —
...
- **The symbol face has to be warmed explicitly, by name and with a private-use
  ...
  is silent: the atlas caches tofu for the pane's life (ADR 0038), which is the
...
- **ADR 0050's point 2 is superseded**; the rest of it — the settings surface,
...
- **Verification stays visual.** As with ADRs 0038 and 0050, nothing in CI can
