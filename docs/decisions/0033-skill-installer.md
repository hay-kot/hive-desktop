# 0033 — Skill installer: install the paste-ready prompts as agent skills, kept in sync by content hash
...
so the app ships paste-ready prompts (`internal/app/prompts`, ADR 0009) — one per
