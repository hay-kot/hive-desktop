# 0045 — A terminal pane claims its atlas renderer on activation, not on mount

- **Status:** accepted
- **Date:** 2026-07-30
- **Amends:** [0038](0038-terminal-atlas-renderer.md) decision 1

## Context

ADR 0038 put every pane on an atlas renderer and loaded it in `attachTab`, the
moment the pane mounts. ADR 0042 then made the terminal view hold several
...
ADR 0038 decision 3 anticipated exactly this and is why it is not a
...
1. **A pane claims its renderer when its window is first shown, not when its
   ...
   renderer yet. This supersedes ADR 0038 decision 1's *timing* — that every
