# 0018 — A shared HTTP toolkit for source connectors
...
ADR 0015 moved the GitHub client into the connector that owns it and named
...
- Request logging is available for every source at debug level, carrying
  ...
  field is the one ADR 0017's proxy exists to conserve, and nothing surfaced
