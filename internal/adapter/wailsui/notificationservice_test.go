...
func (n *fakeNotificationNotifier) Notify(in Input) error {
	n.input = in
	return n.notifyErr
}
...
func TestNotificationServiceForwardsNotifierCalls(t *testing.T) {
	...
	require.Equal(t, Input{Title: "title", Subtitle: "subtitle", Body: "body", Severity: "warning", Sound: true, Data: map[string]any{"id": "1"}}, notifier.input)
