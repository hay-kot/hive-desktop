...
// *coredb.DB itself.
func NewStateResetHarness(db *queries.DB, core *sql.DB, logger zerolog.Logger) *StateReset {
...
func NewStateResetHarnessForInstance(db *queries.DB, core *sql.DB, mock string, paths settings.Paths, logger zerolog.Logger) *StateReset {
